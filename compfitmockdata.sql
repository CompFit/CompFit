...
insert into teams (team_name, captain_id, created) values ('hodbodmommas', 10001, '2016-18-02');
insert into teams (team_name, captain_id, created) values ('fitfunfresh', 20002, '2016-18-02');
insert into teams (team_name, captain_id, created) values ('thunder', 30003, '2016-18-02');
...
insert into challenges (start_date, end_date, to_team_id, from_team_id, task_name, repetitions, units, task_type, status, created) values ('2016-10-02', '2016-17-02', 36, 24, 'Run', 10, 'miles', 'run', 'pending', '2016-10-02');  
insert into challenges (start_data, end_data, to_team_id, from_team_id, task_name, repetitions, units, task_type, status, created) values ('2016-11-02', '2016-18-02', 36, 48, 'Pushups', '5', 'pushups', 'do', 'pending', '2016-11-02');
insert into challenges (start_data, end_data, to_team_id, from_team_id, task_name, repetitions, units, task_type, status, created) values ('2016-12-03', '2016-19-03', 48, 24, 'Burpees', '500', 'burpees', 'do', 'pending', '2016-12-02');
insert into challenges (start_data, end_data, to_team_id, from_team_id, task_name, repetitions, units, task_type, status, created) values ('2016-13-03', '2016-20-03', 48, 36, 'Benchpress 200,000 pounds', '200', 'pounds', 'benchpress', 'pending', '2016-13-02');
insert into challenges (start_data, end_data, to_team_id, from_team_id, task_name, repetitions, units, task_type, status, created) values ('2016-14-03', '2016-21-03', 24, 36, 'Squats', '3000000', 'squats', 'do', 'pending', '2016-14-02');
insert into challenges (start_data, end_data, to_team_id, from_team_id, task_name, repetitions, units, task_type, status, created) values ('2016-15-03', '2016-22-03', 24, 48, 'Run' '100,000', 'meters', 'run', 'pending', '2016-15-02');

#inserting data into exercises
insert into exercises(user_id, date_completed, exercise_name, repetitions, units, created) values (1938, '2016-11-02', 'Run', 2, 'miles', '2016-11-02');
insert into exercises(user_id, date_completed, exercise_name, repetitions, units, created) values (3454, '2016-13-02', 'Run', 1, 'miles', '2016-13-02');
insert into exercises(user_id, date_completed, exercise_name, repetitions, units, created) values (6477, '2016-18-03', 'Burpees', 60, 'burpees', '2016-18-03');
insert into exercises(user_id, date_completed, exercise_name, repetitions, units, created) values (3904, '2016-15-03', 'Squats', 1000, 'sqauts', '2016-15-03');

#inserting data into challenge_progress
insert into challenge_progress (team_id, challenge_id, exercise_id, repetitions, units, created) values (10, 24, 1, 2, 1, 'miles', '2016-23-03')
insert into challenge_progress (team_id, challenge_id, exercise_id, repetitions, units, created) values (20, 36, 5, 4, 1000, 'squats', '2016-23-03')
insert into challenge_progress (team_id, challenge_id, exercise_id, repetitions, units, created) values (30, 48, 3, 2, 60, 'burpees', '2016-23-03')
